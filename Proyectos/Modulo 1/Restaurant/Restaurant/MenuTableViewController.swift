...
class MenuTableViewController: UITableViewController {
    ...
    //Una vez que la solicitud finaliza, verifique el argumento que entra al cierre para ver si contiene datos. Si lo hace, transfiera esos datos a un método que establecerá la propiedad y actualizará la interfaz de manera apropiada.
