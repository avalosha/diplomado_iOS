...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //Almacena esta caché en el directorio temporal de su aplicación, luego, asígnela a la memoria caché compartida que usará la URLSesión compartida cuando realice las solicitudes 
